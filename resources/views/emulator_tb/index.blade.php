...
<link rel="shortcut icon" href="//img.alicdn.com/favicon.ico" type="image/x-icon" />
		...
		<link type="text/css" href="//g.alicdn.com/sd/ncpc/nc.css?t=2018080112" rel="stylesheet" />
...
with(document)with(body)with(insertBefore(createElement("script"),firstChild))setAttribute("exparams","category=&userid=&aplus&yunid=&e778d8eb66a3e&trid=0ab2432515330985454287028e0e6f&asid=AQAAAAAxOmFbQfC1bwAAAADTOHAitVJxpA==",id="tb-beacon-aplus",src=(location>"https"?"//g":"//g")+".alicdn.com/alilog/mlog/aplus_v2.js")
</script>
...
<div class="logo">
    ...
    <div class="login-newbg"  style="background-image: url(https://img.alicdn.com/tfs/TB1EKAeHN9YBuNjy0FfXXXIsVXa-2500-600.jpg);height:600px;">
    ...
    <div class="login-adlink">
        <a href="https:&#x2F;&#x2F;pages.tmall.com&#x2F;wow&#x2F;a&#x2F;act&#x2F;20407&#x2F;upr?wh_pid=main-152136&amp;wh_weex=true&amp;wh_biz=tm" target="_blank" onclick="javascript:goldlog.record('/member.11.2','','','H46777405')"></a>
    </div>
...
密码登录
			...
			<form action="/emulator_tb/member/login.jhtml?redirectURL=https%3A%2F%2Fwww.taobao.com%2F"  method="post" id="J_Form">
		    <div id="J_Message"
				style="display:none;"
			...
			<div class="submit">
				...
				<input id="J_NcoToken" type="hidden" name="ncoToken"
					value="f6cccc40970a472e6cf4199d39f66b22dca52a57" />
				...
				<input type="hidden" name="mobileLoginLink" value="https://login.taobao.com/member/login.jhtml?redirectURL=https://www.taobao.com/&amp;useMobile=true" />
			...
			<ul class="entries">
				<li id="J_OtherLogin" class="other-login">
								...
								<a href="http://weibo.com/login.php?entry=taobao&goto=https%3A%2F%2Flogin.taobao.com%2Faso%2Ftvs%3Fdomain%3Dweibo%26sid%3D41bd386945f3d637e21ad688a67ce04c%26target%3D68747470733A2F2F7777772E74616F62616F2E636F6D2F&goto2=https%3A%2F%2Fwww.taobao.com%2F" tabindex="4" class="weibo-login"><i class="iconfont">&#xe603;</i>微博登录</a>

								<a href="https://auth.alipay.com/login/index.htm?loginScene=7&goto=https%3A%2F%2Fauth.alipay.com%2Flogin%2Ftaobao_trust_login.htm%3Ftarget%3Dhttps%253A%252F%252Flogin.taobao.com%252Fmember%252Falipay_sign_dispatcher.jhtml%253Ftg%253Dhttps%25253A%25252F%25252Fwww.taobao.com%25252F&params=VFBMX3JlZGlyZWN0X3VybD1odHRwcyUzQSUyRiUyRnd3dy50YW9iYW8uY29tJTJG" tabindex="5" class="alipay-login"><i class="iconfont">&#xe618;</i>支付宝登录</a>
    ...
    忘记密码</a>
					...
					<a href="https://passport.taobao.com/ac/nick_find.htm?from_site=0&lang=zh_CN&app_name=tb" target="_blank">忘记会员名</a>
...
window.loginConfig = {
    ...
    codeURL: "",
        ...
        audioCodeURL: "",
        checkUserNameURL:"/emulator_tb/member/request_nick_check.do?_input_charset=utf-8",
...
<!-- #footer END -->
<div id="server-num">login011132216181.center.et2</div>
...
<script type="text/javascript" charset="utf-8" src="//g.alicdn.com/sd/ncpc/nc.js?t=2018080112"></script>
  ...
  function initNC() {
      ...
      var opt = {
          renderTo : "nocaptcha",
				...
				token : "f6cccc40970a472e6cf4199d39f66b22dca52a57",
