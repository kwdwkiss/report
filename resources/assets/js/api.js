module.exports = {
    adminDashboard: '/admin/index/dashboard',
    adminStatementList: '/admin/statement/index',
    adminBehaviorLogList: '/admin/behavior_log/index',

    login: '/admin/index/login',
    logout: '/admin/index/logout',
    adminInfo: '/admin/index/info',
    modifyPassword: '/admin/index/modify_password',
    adminUpload: '/admin/index/upload',
    adminUploadOss: '/admin/index/upload_oss',
    adminUploadOssImage: '/admin/index/upload_oss_image',
