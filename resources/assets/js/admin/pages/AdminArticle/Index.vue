    ...
    <div>
        ...
        <el-row>
            <el-table :data="dataList.data" stripe>
                ...
                <el-table-column prop="type_label" label="文章类型" min-width="100"></el-table-column>
...
<script>
    ...
    export default {
        ...
        data: function () {
            return {
                apiList: api.adminAdminArticleIndex,
                apiUpdate: api.adminAdminArticleUpdate,
                apiDelete: api.adminAdminArticleDelete,
                dataList: {meta: {}},
                search: {},
            }
        },
        ...
        methods: {
            ...
            doUpdate: function (row) {
                this.$router.push({name: 'adminArticleUpdate', params: {id: row.id}});
            },
