    ...
    <div>
        ...
        <el-row>
            <el-table :data="dataList.data" stripe @sort-change="sortChange">
                ...
                <el-table-column prop="columns" label="列数" min-width="110"></el-table-column>
                <el-table-column prop="rows" label="行数" min-width="110"></el-table-column>
