<template>
    <div>
        <div class="row">
            <h3 class="text-center text-success">京东验号工具</h3>
        </div>
        <div class="row">
            <p class="col-xs-offset-1 col-xs-10 text-danger">说明：用微信扫描下方二维码，依次点击下方链接，进入相应页面后截图保存即可。</p>
            <p class="col-xs-offset-1 col-xs-10 text-danger">注意：验号前需要登录京东或者绑定微信</p>
        </div>
        <div class="row">
