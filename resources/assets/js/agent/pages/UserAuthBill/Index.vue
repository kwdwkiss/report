...
<script>
    export default {
        ...
        data: function () {
            return {
                apiList: api.agentUserAuthBillIndex,
                dataList: {meta: {}},
                search: {order_query: {}},
                datePickerOptions: {
                    shortcuts: [{
        ...
        methods: {
            ...
            doCheck: function (id) {
                let self = this;
                axios.post(api.agentUserAuthBillCheck, {id: id}).then(function (res) {
            ...
            doReject: function (id) {
                let self = this;
                axios.post(api.agentUserAuthBillReject, {id: id}).then(function (res) {
                    self.$message.success(res.data.message);
                    self.loadData();
                });
            }
