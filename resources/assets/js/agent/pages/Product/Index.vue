    ...
    <div>
        ...
        <el-row>
            <el-table :data="dataList.data" stripe @sort-change="sortChange">
                ...
                <el-table-column prop="title" label="标题" min-width="110"></el-table-column>
                <el-table-column prop="amount" label="单价" min-width="110"></el-table-column>
                <el-table-column prop="type_label" label="时长类型" min-width="110"></el-table-column>
                <el-table-column prop="duration_label" label="时长范围" min-width="110"></el-table-column>
