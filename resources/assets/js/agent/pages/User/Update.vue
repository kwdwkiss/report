            ...
            <div class="panel-body">
                ...
                <el-tabs v-model="updateActiveName">
                    ...
                    <el-tab-pane label="功能" name="4">
                        <el-form>
                            <el-form-item v-if="!form._report" label="举报功能" labelWidth="100px">
                                <label>尚未开通</label>
                                <el-button type="primary" @click="doEnableReport">开通举报</el-button>
                            </el-form-item>
                            <el-form-item v-if="form._report" label="举报功能" labelWidth="100px">
                            <label>已开通</label>
                            </el-form-item>
...
<script>
    ...
    export default {
        ...
        data: function () {
            return {
                apiShow: api.agentUserShow,
                apiUpdate: api.agentUserUpdate,
        ...
        methods: {
            ...
            uploadChange: function (event) {
                ...
                axios.post(api.agentAttachmentUploadOssImage, formData, {
            ...
            apiKeyUpdate: function () {
                let self = this;
                axios.post(api.agentUserUpdateApiKey, {id: self.form.id}).then(function (res) {
                    self.loadData();
                });
            },
            apiSecretUpdate: function () {
                let self = this;
                axios.post(api.agentUserUpdateApiSecret, {id: self.form.id}).then(function (res) {
                    self.loadData();
                });
            },
            userAuth: function () {
            ...
            doUserAuth: function () {
                let self = this;
                axios.post(api.agentUserUpdateAuth, {
                    id: self.form.id,
            ...
            addDeposit: function () {
                let self = this;
                axios.post(api.agentUserAddDeposit, {
                    id: self.form.id,
            ...
            subDeposit: function () {
                let self = this;
                axios.post(api.agentUserSubDeposit, {
                    id: self.form.id,
                    deposit: self.deposit,
                }).then(function (res) {
                    self.deposit = 0;
            ...
            loadUserRemark: function () {
                let self = this;
                let id = self.$route.params.id;
                axios.get(api.agentUserRemarkIndex, {params: {id: id}}).then(function (res) {
                    self.user_remark = res.data.data;
                });
            },
            createUserRemark: function () {
                let self = this;
                axios.post(api.agentUserRemarkCreate, {
                    id: self.form.id,
            ...
            doEnableFavor: function () {
                let self = this;
                axios.post(api.agentUserEnableFavor, {id: self.form.id}).then(function (res) {
                    self.$message.success('成功');
                    self.loadData();
                });
            },
            doEnableReport: function () {
                let self = this;
                axios.post(api.agentUserEnableReport, {id: self.form.id}).then(function (res) {
                    self.$message.success('成功');
                    self.loadData();
                });
            }
