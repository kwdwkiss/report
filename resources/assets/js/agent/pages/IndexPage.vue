...
<script>
    export default {
        ...
        methods: {
            loadData: function () {
                let self = this;
                axios.get(api.agentSiteGetIndex).then(function (res) {
                    self.data = res.data.data;
                });
            },
            doSave: function () {
                let self = this;
                axios.post(api.agentSiteSetIndex, self.data).then(function () {
            ...
            uploadChange: function () {
                ...
                axios.post(api.agentAttachmentUpload, formData, {
