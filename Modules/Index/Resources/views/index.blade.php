...
<head>
    ...
    <meta name="keywords" content="{{\Modules\Common\Entities\Config::get('site.seo_keywords')}}"/>
    <meta name="description" content="{{\Modules\Common\Entities\Config::get('site.seo_description')}}"/>
